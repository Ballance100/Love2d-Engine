...
skin.name = "Blue"
skin.author = "Orginal: Nikolai Resokav, Modified: Ballance100"
skin.version = "1.0"

local bordercolor = {3/255,236 /255, 252/255, 0}
...
function skin.button(object)
	...
	if not enabled or not clickable then
		-- button body
		love.graphics.setColor(1, 1, 1, 1)
		love.graphics.draw(skin.images["button-unclickable.png"], x, y, 0, width, scaley,0,0)
		-- button text
		love.graphics.setFont(font)
...
function skin.closebutton(object)
	...
	local hoveringImage = skin.images["hovering_close.png"]
	local clickedImage = skin.images["clicked_close.png"]
	...
	if down then
		...
		love.graphics.draw(clickedImage, x, y)
	elseif hover then
		-- button body
		love.graphics.setColor(bodyhovercolor)
		love.graphics.draw(hoveringImage, x, y)
	else
		-- button body
